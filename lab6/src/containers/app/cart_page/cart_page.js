                    ...
                    {cartItems.length > 0 ? (
                        <div>
                            ...
                            <div className={'cart_buttons_box'}>
                                <a className={'cart_button_bottom back'} href={'/catalog'}>
                                    Back to Catalog
                                </a>
                                <a className={'cart_button_bottom continue'} href={"/cart_formik"}>
                                    Continue
                                </a>
                            </div>
                        </div>
                        ...
                        <div className={'empty_cart'}>
                            ...
                            <a className={'cart_button_bottom back empty_cart'} href={'/catalog'}>
                                Back to Catalog
                            </a>
                            </div>
                        </div>
